...
- [`CASE_CLASS_HYBRID.md`](CASE_CLASS_HYBRID.md) — prior art showing that analogy + outside view is already an established forecasting hybrid; isolates the narrower foundation-model frontier.
